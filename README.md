...
You can find the subject ***[here](https://github.com/kenlies/42ft_printf/blob/main/en.subject.pdf)***. It gives an overview and contains the exact requirements for this project.
...
Because the makefile just builds a library containing the function, we need to link during compilation:
  ...
  1. ```https://github.com/kenlies/42ft_printf```
  2. ```cd 42ft_printf```
